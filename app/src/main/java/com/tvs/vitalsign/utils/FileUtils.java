package com.tvs.vitalsign.utils;
...
public class FileUtils {
    ...
    public static final String ROOT =
            VitalSignApp.context.getExternalFilesDir(null).getAbsolutePath() + File.separator + "facerecognizer";

    public static final String DATA_FILE = "data";
    public static final String MODEL_FILE = "model";
    public static final String LABEL_FILE = "label";

    public static final String LABELMAP_FILE = "labelmap";
