...
import com.tvs.vitalsign.utils.FileUtils;
...
//        recognizer.mobileNet = MobileNet.create(assetManager);
//        recognizer.classNames = FileUtils.readLabel(FileUtils.LABEL_FILE);
    ...
    public List<Recognition> recognizeImage(Bitmap bitmap, Matrix matrix, float confidence) {
        synchronized (this) {
            ...
            for (RectF rectF : faces) {
                ...
                Recognition result =
                        new Recognition("", "Face", confidence, rectF);
