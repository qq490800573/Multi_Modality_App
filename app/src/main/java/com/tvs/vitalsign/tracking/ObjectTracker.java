...
import com.tvs.vitalsign.utils.Size;
...
/**
 ...
 After allocation, new TrackedObjects may be instantiated via trackObject(). Tracked
 Objectsare associated with the ObjectTracker that created them, and are only valid while that
