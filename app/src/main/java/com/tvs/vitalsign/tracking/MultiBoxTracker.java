...
package com.tvs.vitalsign.tracking;
...
import com.tvs.vitalsign.ml.Recognizer.Recognition;
import com.tvs.vitalsign.utils.ImageUtils;
import com.tvs.vitalsign.utils.Logger;
...
public class MultiBoxTracker {
    ...
    public MultiBoxTracker(final Context context) {
        ...
        boxPaint.setColor(Color.parseColor("#31cb03"));
    ...
    public synchronized void draw(final Canvas canvas) {
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            float left = trackedPos.left;
            trackedPos.left = canvas.getWidth() - trackedPos.right;
            trackedPos.right = canvas.getWidth() - left;
